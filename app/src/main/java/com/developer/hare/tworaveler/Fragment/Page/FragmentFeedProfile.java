                            ...
                            switch (result.getSuccess()) {
                                case CODE_SUCCESS:
                                    ...
                                    if(NullChecker.getInstance().nullCheck(model.getProfile_pic_url())){
                                         ...
                                         imageManager.loadImage(imageManager.createRequestCreator(getActivity(), model.getProfile_pic_thumbnail_url(), ImageManager.THUMBNAIL_TYPE).centerInside().placeholder(R.drawable.image_profile), IV_profile);
                                    }
                                    break;
                                case CODE_NOT_LOGIN:
                                    break;
